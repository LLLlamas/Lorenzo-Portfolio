...
export function Capabilities() {
  return (
    <section id="capabilities" className="border-y border-line bg-bg-elevated px-6 py-24 md:py-32">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {copy.capabilities.items.map((item, i) => {
            const Icon = icons[i];
            return (
              <Card key={item.title} className="group p-6 transition-shadow hover:shadow-sm">
